...
})({"g6TVA":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "485c2057d010fdfd";
"use strict";
...
},{}],"etDPs":[function(require,module,exports) {
var _main = require("./main");
let { events  } = data;
let upcommingEvents = (0, _main.selectEvents)(events, {
    upcomming: true
});
(0, _main.renderShowCase)(upcommingEvents, (0, _main.cardShow)); // Muestra Upcomming events
console.log(upcommingEvents.length);

},{"./main":"1SICI"}],"1SICI":[function(require,module,exports) {
// Import all of Bootstrap's JS
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "selectEvents", ()=>selectEvents);
parcelHelpers.export(exports, "cardShow", ()=>cardShow);
parcelHelpers.export(exports, "renderShowCase", ()=>renderShowCase);
...
const getCategories = (events)=>{
    let categories = [];
    for (let event of events)if (!categories.includes(event.category)) categories.push(event.category);
    return categories;
};
...
const getUpcommingPastEvents = (events, currentDate)=>{
    ...
    for (let event of events)if (Date.parse(event.date) > Date.parse(currentDate)) eventsDivided.upcommingEvents.push(event);
    else eventsDivided.pastEvents.push(event);
    return eventsDivided;
};
const selectEvents = (events, { upcomming =false , past =false , catEvents =[]  } = {}, currentD = currentDate)=>{
    //Función de discriminación de eventos por categoría.
    let result = [];
    console.log(catEvents.length);
    if (catEvents.length === 0) result = events;
    else for (let event of events){
        for (let cat of catEvents)if (CATEGORIES.includes(cat) && event.category === cat) result.push(event);
    }
    if (upcomming) result = getUpcommingPastEvents(result, currentD).upcommingEvents;
    if (past) result = getUpcommingPastEvents(result, currentD).pastEvents;
...
},{"bootstrap":"h36JB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["g6TVA","etDPs"], "etDPs", "parcelRequire0f88")

//# sourceMappingURL=upcoming.d010fdfd.js.map
